...
public class Orc extends Character{
    private String claw;
    private String mace;
    private double hpMultiplier=1.9;
    private double orcHp;
    private double staminaMultiplier=1.3;
    private double orcStamina;
    private double magicMultiplier=0.4;
    private double orcMagic;
    private final int minHeight=178;
    private final int maxHeight=230;
