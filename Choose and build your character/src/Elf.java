...
public class Elf extends Character {
    private String bow;
    private double hpMultiplier = 0.9;
    private double elfHp;
    private double staminaMultiplier = 1.6;
    private double elfStamina;
    private double magicMultiplier = 1.7;
    private double elfMagic;
    private final int minHeight = 152;
